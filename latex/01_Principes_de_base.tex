...
\begin{columns}
\column{.45\textwidth}\begin{block}{Avantages}
\begin{itemize}
\item Reproductibilité des traitements
...
\end{itemize}
\end{block}
\column{.45\textwidth}\begin{block}{Inconvénients}
\begin{itemize}
\item Faible débit
...
\begin{itemize}
\item 1964 $\rightarrow$ mégaFLOPS\note{Nombre d'opérations en virgule flottante pas seconde} : Control Data 6600
