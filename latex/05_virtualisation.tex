...
\item virtualisation complète (KVM\note{Kernel-based Virtual Machine} sur Inter-VT ou AMD-V)
\end{itemize}
\item Inclut :
\begin{itemize}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[height=6cm]{../illustration/docker-hub.jpg} % requires the graphicx package
