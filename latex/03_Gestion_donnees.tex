  ...
  \begin{exampleblock}{Premier disque dur commercialisé}
    \begin{columns}
      ...
      \begin{itemize}
        ...
        \item \textbf{5 Mo} - 50 plateaux de 24 pouces - 1200 tours/minute - 8,8 Ko/s
        \item 50 000 \$ - 1000 exemplaires vendus - 1 tonne
      \end{itemize}
      \column{.3\textwidth}
...
\begin{exampleblock}{DWPD (drive writes per day)\footnote{souvent plus de 3 ou 5, même pour les TLC (2017)}}
  Cycles de réécritures complètes du SSD quotidienne / durée de la garantie constructeur
\end{exampleblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Disques externes, mais relié directement au système
...
% \begin{itemize}
% \item Chargement des registres définissant l'espace d'adressage en mode privilégié
% \begin{itemize}
%\item Base et limite
%\item Table de transcodage
%\end{itemize}
%
