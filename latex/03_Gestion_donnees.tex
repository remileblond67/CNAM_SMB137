...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item accès bas niveau aux disques (protocoles proches de celui des disques internes - ATA, SCSI) - mode bloc
      \item Protocoles SCSI, Fibre Channel, FCoE, iSCSI, ATA over Ethernet (AoE) ou HyperSCSI
    \end{itemize}
