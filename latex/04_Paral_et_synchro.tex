...
\begin{itemize}
\item Les données perdent leur cohérence si plusieurs producteurs et/ou consommateur mettent à jour les variables \texttt{in}, \texttt{out}, \texttt{count} et le tableau \texttt{tampon} de manière concurrente
\item Besoin : 
\begin{itemize}
